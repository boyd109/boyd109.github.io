...
Top `2%` in Leetcode Weekly Contests, `2000+` rating, `450+` solved Leetcode questions: [Leetcode](https://leetcode.com/jonathantsang/)

Ranked 16th in [University of Waterloo](https://open.kattis.com/universities/uwaterloo.ca)

Ranked 26th in [Ontario](https://open.kattis.com/countries/CAN/ON)
...
#### Zynga - Toronto
This was a game team working on Poker with Unity. I actually was really interested in working on a game. I solved the question of how to remove duplicates from a linked list, and I felt we connected very well since I had prior Unity experience and I had published my game to the Steam store using Unity. I thought I was getting the offer for this one. **Ranked**
...
This was all behavioural. I remember for some reason I booked the earliest time slot at 8am or something. During the interview my alarm to wake up (8:30am) went off, cause in most circumstances I would have been asleep. I'm gonna be honest it seemed fine as a 1st or 2nd co-op but defintely not great from a career growth standpoint. **Ranked**


#### Curvegrid - Japan?
They asked me some overflow question or something. They were working out of Japan and was doing something with blockchain. I think they also decided to interview 30+ people for 1 position. I also think they ranked everyone? **Ranked**
...
I ended up ranking them a 4 and whoever got ranked got the job.

#### Iotex - SF
This was a blockchain IOT startup. They had smart people and seemed really cool. I did a few rounds involving behavioural, system design (which up until that point I had no idea what I was doing), and an algorithm question. I distinctly remember after failing to find "k-th largest element in array" they selected someone else. I had done maybe 2-3 rounds over a couple of weeks but to no avail. **Not Ranked**

#### Vida Health - SF
They asked some algo thing. They are a Velocity start-up and at the time I was staying at the Velocity residence. The guy who got this offer was actually in the dorm adjacent to mine and I got ranked. He ended up taking it, so I was out of luck. **Ranked**

#### Universe - Toronto
I'm gonna be honest I don't remember much. I think I failed their algo question. **Ranked**

#### Many Roads Studios - Toronto
The interviewer was not happy I put comments explaining my code in the interview. Was not impressed after talking for an hour when interviewer explained my role and overall impression from the interview. **Offer**

#### Procom - Toronto
Honestly these interviewers were really chill. I remember one of them said they switched into CS (just like me). He laid out an "easy" problem, a "medium" problem, and a "hard" problem. For some reason I chose medium and couldn't solve the search a 2d array. I thought it involved some complex binary search and divide and conquering. (which it doesn't) **Ranked**
...
#### Nvidia - ???
I interviewed for a UI/UX intern from Nvidia because cs349 put a job posting for it and I hadn't found a co-op yet. This interview process took **FOREVER**. I probably was actively interviewing for a month and a half. I ended up saying I was moving onto other opportunities. **I exited the interview process**
...
#### Demonware - Vancouver
I interviewed for some cloud team. They asked me some topological sort question with a solution involving DFS for dependencies. They also asked some unix trivia. **Offer but turned down**. My main motivation for turning it down was they were not willing to budge in any capacity when I tried to negotiate pay and length (8 months only). Their work seemed really cool and they told me they worked closely with Activision.

#### Google - ???
I did the coding challenge and 3 phone interviews. the first 2 went poorly but the third one I solved it all and killed it. I waited (the full) 3 weeks from the hiring committee to hear their decision. They then said no. **Rejected**
...
#### MixMax
I used won their API prize at MHacks 10 and I tried use that connection to interview with them. They had a Javascript question and all I remember is the interviewer loudly slurping their bubble tea during the interview. They also asked for a reference letter **before** giving an offer. **Rejected**
...
#### Honey
I had a phone interview. The interviewer asked me a DP question with a knight on a phone dialpad. Solving graphically it is not hard but visualizing the DP is...well interesting for an interview at least. **Rejected**
...
#### theTradeDesk - SF
Applied externally. Had a system design question and regular algorithm question. Fairly easy interview and decent compensation. **Offer but turned down**
...
#### Okta - Toronto (again)
I tried to interview again despite them telling me (originally) they did not want me to return. **Ranked**
...
Did 2 1hr interviews. (fairly easy) algorithmic interviews.
**Offer**

#### C3.ai - Redwood City
Applied externally. Did multiple rounds.
**Offer but turned down**
...
### Summer 2019
While at Zenefits I continued to interview. This was also my last time using WaterlooWorks since my last co-op was Fall 2019. This is from applying outsite and using 50 jobs on WaterlooWorks.

#### Salesforce - SF
Did a coding challenge, (fairly easy) algorithmic interview, and manager interview. **Not Ranked**

#### Amazon - Vancouver/Seattle?
Did a coding challenge, (fairly easy) algorithmic interview, and behavioural interview. **Ran out of spots (lol)** They said I passed the interview but ran out of spots. They also told me I couldn't defer it to a later term like what Google does.

#### LinkedIn - Sunnyvale
Did 2 1hr interviews one focused on UI. The algorithm interview one was trivial but UI one I struggled with since I didn't know any UI. Then manager/team host matching. **Offer**
...
Did a few interviews when they were still in stealth mode. **Rejected**

#### Figma - SF - Software Engineer Intern
Did onsite in SF. Solved all questions. Weakest aspect of my game is probably formal system design. **Rejected**

#### Palantir - Palo Alto - Software Engineer Intern
Did onsite in Palo Alto. Solved all questions. Weakest aspect of my game is probably formal system design.**Rejected**

#### Dropbox - SF - Software Engineer Intern
Did onsite in SF. **Rejected**
...
Did a few phone interview rounds. **Rejected**
...
Did a coding challenge and onsite in Menlo Park. Solved all questions. Weakest aspect of my game is probably formal system design. **Rejected**
...
Did phone screen and onsite in SF. Rejected due to not solving assembly question about pointers and memory assignment. **Rejected**

#### Axon - Seattle - Software Engineer Intern
Did phone screen. **Offer but turned down**

#### Asana - Vancouver - Software Engineer New Grad
Did phone screen and got rejected from that due to not system designing chess very well. **Rejected**
